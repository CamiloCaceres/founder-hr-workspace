---
name: debrief-loop
description: Use when the user says "synthesize {candidate}'s panel feedback" / "hire or no-hire on {candidate}" / "debrief the loop" — aggregates interviewer feedback, extracts themes, surfaces contradictions, scores against the rubric, and produces a hire / no-hire decision memo. Recommendation only — founder decides.
---
...
8. **Check escalation rules.** If any feedback touches protected-
   ...
   people-context.md. Do not produce a recommendation on those
   grounds.
