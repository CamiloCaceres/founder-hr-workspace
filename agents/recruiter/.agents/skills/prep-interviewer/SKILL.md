...
description: Use when the user says "prep me to interview {candidate}" / "what should I ask {candidate}" / "interview brief for {candidate}" — builds an interviewer-side brief (background summary, likely questions, red flags to probe, reference themes, scoring rubric). Not candidate-side prep — this is flipped.
---
